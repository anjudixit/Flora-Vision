...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-[165vh] max-[640px]:min-h-[200vh] sm:min-h-[220vh] md:min-h-[180vh] lg:min-h-[200vh] bg-[#182015]">
      ...
      <div
        className=" absolute top-[70vh] max-[640px]:top-[90vh] sm:top-[100vh] md:top-[95vh] lg:top-[112vh] left-0 w-full flex flex-col gap-14 px-4 md:px-8 z-10"
      >
        <TrendyPlantCard1 />
        <TrendyPlantCard2 />
      </div>
