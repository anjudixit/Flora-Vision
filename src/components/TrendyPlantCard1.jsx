...
const TrendyPlantCard1 = () => {
  return (
    <div className="relative mx-auto w-[90%] md:w-260 h-100 md:h-70 bg-white/5 backdrop-blur-md border border-white/20 rounded-[50px] md:rounded-[80px] px-6 md:px-12 py-8 flex flex-col md:flex-row items-center overflow-visible">
      ...
      <img src={plant_img} alt="plant" className="absolute -top-16 md:-top-24 left-1/2 md:left-4 -translate-x-1/2 md:translate-x-0 w-44 md:w-90 z-20"/>

      <div className="w-full md:w-[40%] h-32 md:h-auto"></div>

      <div className="text-white md:w-[50%] mt-6 md:mt-0 z-20 flex flex-col text-center md:text-left">
